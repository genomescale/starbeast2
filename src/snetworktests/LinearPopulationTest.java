...
import speciesnetwork.LinearPopulation;
...
public class LinearPopulationTest extends PopulationTestHelper {
    ...
    public LinearPopulationTest() throws Exception {
        popSize = 0.3;
        ploidy = 2.0;
        nSpecies = 4;
        expectedLogP = 3.622793963076785; // I have no idea if this is the right answer

        newickSpeciesNetwork = "((s0:0.32057156677143211,s3:0.32057156677143211):1.2653250035015629,(s1:0.56540722294658641,s2:0.56540722294658641):1.0204893473264085)";
    ...
    public PopulationSizeModel generatePopulationModel() throws Exception {
        ...
        PopulationSizeModel populationModel = new LinearPopulation();
