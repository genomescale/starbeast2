...
public class MissingDataCoordinatedExchange {
    private final String newickSpeciesTree = "((A:1.0,B:1.0):2.0,C:3.0)";
    private final String newickGeneTreeA = "((A1:1.5,B1:1.5):1.0,(A2:2.0,B2:2.0):0.5)";
    ...
    final double expectedLogHR = Double.NEGATIVE_INFINITY; // this should be the right answer (no destination branches)
